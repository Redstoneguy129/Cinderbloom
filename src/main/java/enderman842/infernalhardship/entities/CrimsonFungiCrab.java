...
public class CrimsonFungiCrab extends MonsterEntity {
	public CrimsonFungiCrab(EntityType<? extends MonsterEntity> type, World world) {
		super((EntityType<? extends MonsterEntity>) ItemsNStuffRegistry.crimson_fungi_crab, world);
