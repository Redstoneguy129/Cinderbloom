...
public class Scorched extends MonsterEntity {
	public Scorched(EntityType<? extends MonsterEntity> type, World world) {
		super((EntityType<? extends MonsterEntity>) ItemsNStuffRegistry.scorched, world);
	}
	@Override
