...
public class WitherslagCrab extends MonsterEntity {
	public WitherslagCrab(EntityType<? extends MonsterEntity> type, World world) {
		super((EntityType<? extends MonsterEntity>) ItemsNStuffRegistry.witherslag_crab, world);
