...
public class BloodyCrab extends MonsterEntity {
	public BloodyCrab(EntityType<? extends MonsterEntity> type, World world) {
		super((EntityType<? extends MonsterEntity>) ItemsNStuffRegistry.bloody_crab, world);
