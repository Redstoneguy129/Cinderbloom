...
public class NetherCrab extends MonsterEntity {
	public NetherCrab(EntityType<? extends MonsterEntity> type, World world) {
		super((EntityType<? extends MonsterEntity>) ItemsNStuffRegistry.nether_crab, world);
