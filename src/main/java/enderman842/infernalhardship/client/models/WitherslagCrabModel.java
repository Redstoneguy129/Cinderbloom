...
public class WitherslagCrabModel extends EntityModel<WitherslagCrab> {
	...
	@Override
	public void setRotationAngles(WitherslagCrab entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
