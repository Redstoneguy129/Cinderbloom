...
public class ScorchedModel extends EntityModel<Scorched> {
	...
	@Override
	public void setRotationAngles(Scorched entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
