...
public class CrimsonFungiCrabModel extends EntityModel<CrimsonFungiCrab> {
	...
	@Override
	public void setRotationAngles(CrimsonFungiCrab entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
